...
public class ScannerGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		do {
			...
			// enter grammar name
			System.out.print("Enter the name of the grammar file including the extension: ");
			...
			//run the parser generator and parser
			HashMap<String, HashMap<String, String>> table = ParserGenerator.generateParsingTable(grammar);
			Scanner scan = new Scanner(new FileReader(grammar));
			...
			System.out.println("See results of parsing in stackOutput.txt");
